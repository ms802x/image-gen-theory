...
Open the notebooks from [homeworks/](homeworks/).
...
- Notebook files are generated by [scripts/create_homework_notebooks.py](scripts/create_homework_notebooks.py), so the sequence can be rebuilt consistently.
